...
layout(set = 5, binding = 1) uniform Params {
...
layout(std430, set = 5, binding = 2) readonly buffer LightGridSSBO {
	LightGrid lightGrid[];
};
layout(std430, set = 5, binding = 3) readonly buffer LightIndexSSBO {
